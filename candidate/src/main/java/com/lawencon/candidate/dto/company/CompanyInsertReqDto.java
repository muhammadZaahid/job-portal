...
public class CompanyInsertReqDto {
	...
	public String toString() {
		return "CompanyInsertReqDto [companyCode=" + companyCode + ", companyName=" + companyName + ", companyDesc="
				+ companyDesc + ", companyTaxNumber=" + companyTaxNumber + ", companyLogo=" + companyLogo
